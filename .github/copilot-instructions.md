...
You are contributing to **Veggerby.Boards**, a focused .NET library for strongly-typed measurements, deterministic dimensional reduction, and algebra over physical units.
