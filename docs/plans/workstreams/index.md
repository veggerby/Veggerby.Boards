...
| 17 | Deck-building Core Module | partial | Core zone mechanics + Action/Buy split + deterministic baseline locked; supply helpers and scoring next. |
