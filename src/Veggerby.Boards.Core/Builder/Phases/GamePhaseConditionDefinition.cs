...
namespace Veggerby.Boards.Core.Builder.Phases
{
    ...
    {
        public GamePhaseConditionDefinition(GameEngineBuilder builder, GameStateConditionFactory conditionFactory, IThenGameEventRule parent) : base(builder, parent)
        {
