...
/// <summary>
/// Condition that checks if a player can decline a trade.
/// </summary>
public class CanDeclineTradeCondition : IGameEventCondition<DeclineTradeGameEvent>
{
    /// <inheritdoc />
    public ConditionResponse Evaluate(GameEngine engine, GameState state, DeclineTradeGameEvent @event)
    {
