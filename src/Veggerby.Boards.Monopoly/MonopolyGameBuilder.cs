    ...
    protected override void Build()
    {
        ...
        AddGamePhase("monopoly gameplay")
            ...
            .Then()
                ...
                // Passing Go (for explicit manual events - auto-handled in MovePlayerStateMutator)
                ...
                // Stay in jail (jail turn tracking)
                .ForEvent<StayInJailGameEvent>()
                    .If<PlayerInJailCondition>()
                    .Then()
                        .Do<StayInJailStateMutator>()
                // End turn (switch to next player)
                .ForEvent<EndTurnGameEvent>()
                    .If(game => new AlwaysValidCondition<EndTurnGameEvent>())
                    .Then()
                        .Do<EndTurnStateMutator>()
                // Player elimination
