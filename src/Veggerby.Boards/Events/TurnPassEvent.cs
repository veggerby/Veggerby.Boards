...
/// </summary>
/// <remarks>
/// Turn passing provides an explicit alternative to completing all segments (e.g., Start→Main→End) when
/// no further actions are desired or legal. Future segment models (Upkeep, Roll, Commit) may restrict
/// pass eligibility to certain segments; current minimal profile allows passing from any segment.
/// </remarks>
